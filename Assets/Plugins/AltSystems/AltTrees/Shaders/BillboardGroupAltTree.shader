Shader "AltTrees/BillboardGroup"
{
	...
	/*SubShader
    {
		...
		CGPROGRAM
			...
			#pragma target 3.0
			#pragma multi_compile __ ONEPLANE
	...
	SubShader
    {
		Tags {"Queue"="AlphaTest" "RenderType"="TransparentCutout" "DisableBatching"="True" "IgnoreProjector"="True" "ForceNoShadowCasting" = "True" }
		LOD 1000
		
		CGPROGRAM
		
		#pragma surface surf Lambert vertex:vert nolightmap nodynlightmap fullforwardshadows  alphatest:_Cutoff noshadow
