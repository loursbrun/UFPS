#ifndef SPEEDTREE_WIND_ALTTREE_INCLUDED
#define SPEEDTREE_WIND_ALTTREE_INCLUDED

///////////////////////////////////////////////////////////////////////  
//  Wind Info

/*uniform float4 _ST_WindVector;		// xyz - направление ветра. w - показатель main из Wind Zone
uniform float4 _ST_WindGlobal;
uniform float4 _ST_WindBranch;
uniform float4 _ST_WindBranchTwitch;
uniform float4 _ST_WindBranchWhip;
uniform float4 _ST_WindBranchAnchor;
uniform float4 _ST_WindBranchAdherences;
uniform float4 _ST_WindTurbulences;
uniform float4 _ST_WindLeaf1Ripple;
uniform float4 _ST_WindLeaf1Tumble;
uniform float4 _ST_WindLeaf1Twitch;
uniform float4 _ST_WindLeaf2Ripple;
uniform float4 _ST_WindLeaf2Tumble;
uniform float4 _ST_WindLeaf2Twitch;
uniform float4 _ST_WindFrondRipple;
uniform float4 _ST_WindAnimation;*/


CBUFFER_START(SpeedTreeAltWind)
...
#endif // SPEEDTREE_WIND_ALTTREE_INCLUDED
